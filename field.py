...
try:
  while True:
    GPIO.wait_for_edge(7, GPIO.RISING) # Look for the field pulse
    GPIO.output(11, GPIO.HIGH) # blink the LED
    GPIO.wait_for_edge(7, GPIO.FALLING) # Look for the field pulse
    GPIO.output(11, GPIO.LOW) # blink the LED
